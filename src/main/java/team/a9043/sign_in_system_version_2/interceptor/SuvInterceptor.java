...
@Component
public class SuvInterceptor implements HandlerInterceptor {
    private RedisTemplate redisTemplate;

    @Autowired
    public SuvInterceptor(RedisTemplate redisTemplate) {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        //permit
        if ((user.getUsrPermit() & 2) != 2) {
            throw new InsufficientPermissionsException("You are not an supervisor!");
        }
