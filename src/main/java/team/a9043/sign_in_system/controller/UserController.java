...
public class UserController {
    ...
    public OperationResponse getTokens(@PathVariable
    ...
    public OperationResponse modifyBindUser(@TokenUser @ApiIgnore SisUser sisUser,
    ...
    @ApiOperation("修改密码")
    public OperationResponse modifyPassword(@PathVariable @ApiParam("用户Id") String suId,
    ...
    @PreAuthorize("hasAuthority('ADMINISTRATOR')")
    public OperationResponse deleteUser(@PathVariable String suId) throws IncorrectParameterException {
