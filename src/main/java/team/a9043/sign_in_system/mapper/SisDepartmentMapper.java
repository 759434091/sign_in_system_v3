...
public interface SisDepartmentMapper {
     ...
     * @mbg.generated Sat Sep 01 22:13:45 CST 2018
     */
    int updateByExampleSelective(@Param("record") SisDepartment record, @Param("example") SisDepartmentExample example);
     ...
     * @mbg.generated Sat Sep 01 22:13:45 CST 2018
     */
    int updateByExample(@Param("record") SisDepartment record, @Param("example") SisDepartmentExample example);
