...
public interface SisLocationMapper {
     ...
     * @mbg.generated Sat Sep 01 21:38:31 CST 2018
     */
    int updateByExampleSelective(@Param("record") SisLocation record, @Param("example") SisLocationExample example);
     ...
     * @mbg.generated Sat Sep 01 21:38:31 CST 2018
     */
    int updateByExample(@Param("record") SisLocation record, @Param("example") SisLocationExample example);
